# -*- coding: utf-8 -*-
#
# zoocore documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'ZooCore.tex', u'ZooCore Documentation',
...
man_pages = [
    (master_doc, 'ZooCore', u'ZooCore Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ZooCore', u'ZooCore Documentation',
     author, 'ZooCore', 'One line description of project.',
     'Miscellaneous'),
]
